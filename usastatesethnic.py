...
def calcResult(name, pop, blat, bbla, bwhi, tlat, tbla, twhi, percl, percb, percw):
	...
	if(not(len(set(tlat)) + len(set(blat)) < 1)):
		...
		print("Trump Latino:", trlat)
		print("Biden Latino:", bilat)
	else:
		print("No Latino Tweets Registered in This District")
	print(f"Black ({percb*100}%)")
	if(not(len(set(tbla)) + len(set(bbla)) < 1)):
		...
		print("Trump Black:", trbla)
		print("Biden Black:", bibla)
	else:
		print("No Black Tweets Registered in This District")
	print(f"Others ({percw*100}%)")
	if(not(len(set(twhi)) + len(set(bwhi)) < 1)):
		...
		print("Trump Others:", trwhi)
		print("Biden Others:", biwhi)
	else:
...
# with open("/Volumes/TOSHIBA_BACKUP/usastateswithethnic.txt", 'rb') as f:
...
calcResult("Arizona", 759663, az1bl, az1bb, az1bw, az1tl, az1tb, az1tw, 0.302, 0.043, 0.65)
print("")
calcResult("Arkansas", 724622, ar1bl, ar1bb, ar1bw, ar1tl, ar1tb, ar1tw, 0.069, 0.155, 0.76)
print("")
calcResult("Alabama", 715346, al1bl, al1bb, al1bw, al1tl, al1tb, al1tw, 0.039, 0.265, 0.68)
print("")
calcResult("Colorado", 812843, co1bl, co1bb, co1bw, co1tl, co1tb, co1tw, 0.209, 0.041, 0.73)
print("")
calcResult("California", 704012, ca1bl, ca1bb, ca1bw, ca1tl, ca1tb, ca1tw, 0.381, 0.059, 0.53)
print("")
calcResult("Connecticut", 710509, ct1bl, ct1bb, ct1bw, ct1tl, ct1tb, ct1tw, 0.142, 0.104, 0.74)
print("")
calcResult("Georgia", 734172, ga1bl, ga1bb, ga1bw, ga1tl, ga1tb, ga1tw, 0.087, 0.312, 0.58)
print("")
calcResult("Florida", 762506, fl1bl, fl1bb, fl1bw, fl1tl, fl1tb, fl1tw, 0.234, 0.161, 0.58)
print("")
calcResult("Indiana", 714756, in1bl, in1bb, in1bw, in1tl, in1tb, in1tw, 0.064, 0.092, 0.83)
print("")
calcResult("Iowa", 773628, ia1bl, ia1bb, ia1bw, ia1tl, ia1tb, ia1tw, 0.055, 0.033, 0.90)
print("")
calcResult("Illinois", 706550, il1bl, il1bb, il1bw, il1tl, il1tb, il1tw, 0.164, 0.143, 0.68)
print("")
calcResult("Idaho", 912950, id1bl, id1bb, id1bw, id1tl, id1tb, id1tw, 0.119, 0.006, 0.86)
print("")
calcResult("Kansas", 725222, ks1bl, ks1bb, ks1bw, ks1tl, ks1tb, ks1tw, 0.111, 0.058, 0.80)
print("")
calcResult("Kentucky", 717739, ky1bl, ky1bb, ky1bw, ky1tl, ky1tb, ky1tw, 0.032, 0.079, 0.87)
print("")
calcResult("Louisiana", 803427, la1bl, la1bb, la1bw, la1tl, la1tb, la1tw, 0.046, 0.322, 0.61)
print("")
calcResult("Maine", 683279, me1bl, me1bb, me1bw, me1tl, me1tb, me1tw, 0.014, 0.012, 0.95)
print("")
calcResult("Maryland", 662062, md1bl, md1bb, md1bw, md1tl, md1tb, md1tw, 0.087, 0.296, 0.60)
print("")
calcResult("Massachusetts", 634479, ma1bl, ma1bb, ma1bw, ma1tl, ma1tb, ma1tw, 0.101, 0.073, 0.81)
print("")
calcResult("Michigan", 699621, mi1bl, mi1bb, mi1bw, mi1tl, mi1tb, mi1tw, 0.046, 0.139, 0.79)
print("")
calcResult("Mississippi", 762914, ms1bl, ms1bb, ms1bw, ms1tl, ms1tb, ms1tw, 0.028, 0.375, 0.59)
print("")
calcResult("Missouri", 728365, mo1bl, mo1bb, mo1bw, mo1tl, mo1tb, mo1tw, 0.038, 0.116, 0.83)
print("")
calcResult("Minnesota", 678418, mn1bl, mn1bb, mn1bw, mn1tl, mn1tb, mn1tw, 0.049, 0.057, 0.88)
print("")
calcResult("New Jersey", 729675, nj1bl, nj1bb, nj1bw, nj1tl, nj1tb, nj1tw, 0.184, 0.135, 0.66)
print("")
calcResult("New Mexico", 690571, nm1bl, nm1bb, nm1bw, nm1tl, nm1tb, nm1tw, 0.475, 0.02, 0.48)
print("")
calcResult("Nebraska", 616728, ne1bl, ne1bb, ne1bw, ne1tl, ne1tb, ne1tw, 0.1, 0.047, 0.83)
print("")
calcResult("New Hampshire", 673194, nh1bl, nh1bb, nh1bw, nh1tl, nh1tb, nh1tw, 0.031, 0.013, 0.94)
print("")
calcResult("Nevada", 722331, nv1bl, nv1bb, nv1bw, nv1tl, nv1tb, nv1tw, 0.274, 0.086, 0.62)
print("")
calcResult("North Carolina", 750278, nc1bl, nc1bb, nc1bw, nc1tl, nc1tb, nc1tw, 0.086, 0.215, 0.69)
print("")
calcResult("New York", 717707, ny1bl, ny1bb, ny1bw, ny1tl, ny1tb, ny1tw, 0.173, 0.156, 0.65)
print("")
calcResult("Ohio", 739216, oh1bl, oh1bb, oh1bw, oh1tl, oh1tb, oh1tw, 0.033, 0.123, 0.83)
print("")
calcResult("Oregon", 844175, or1bl, or1bb, or1bw, or1tl, or1tb, or1tw, 0.123, 0.019, 0.85)
print("")
calcResult("Oklahoma", 754310, ok1bl, ok1bb, ok1bw, ok1tl, ok1tb, ok1tw, 0.097, 0.073, 0.81)
print("")
calcResult("Hawaii", 692981, hi1bl, hi1bb, hi1bw, hi1tl, hi1tb, hi1tw, 0.089, 0.018, 0.88)
print("")
calcResult("South Carolina", 668668, sc1bl, sc1bb, sc1bw, sc1tl, sc1tb, sc1tw, 0.051, 0.274, 0.65)
print("")
calcResult("Texas", 717735, tx1bl, tx1bb, tx1bw, tx1tl, tx1tb, tx1tw, 0.383, 0.119, 0.48)
print("")
calcResult("Tennessee", 714504, tn1bl, tn1bb, tn1bw, tn1tl, tn1tb, tn1tw, 0.049, 0.168, 0.76)
print("")
calcResult("Pennsylvania", 655146, pa1bl, pa1bb, pa1bw, pa1tl, pa1tb, pa1tw, 0.061, 0.11, 0.81)
print("")
calcResult("Rhode Island", 539250, ri1bl, ri1bb, ri1bw, ri1tl, ri1tb, ri1tw, 0.129, 0.065, 0.80 )
print("")
calcResult("Utah", 100000, ut1bl, ut1bb, ut1bw, ut1tl, ut1tb, ut1tw, 0.134, 0.011, 0.84)
print("")
calcResult("Virginia", 776836, va1bl, va1bb, va1bw, va1tl, va1tb, va1tw, 0.083, 0.192, 0.71)
print("")
calcResult("Washington", 654904, wa1bl, wa1bb, wa1bw, wa1tl, wa1tb, wa1tw, 0.119, 0.036, 0.82)
print("")
calcResult("West Virginia", 615991, wv1bl, wv1bb, wv1bw, wv1tl, wv1tb, wv1tw, 0.014, 0.034, 0.93)
print("")
calcResult("Wisconsin", 717716, wi1bl, wi1bb, wi1bw, wi1tl, wi1tb, wi1tw, 0.063, 0.063, 0.85)
print("")
calcResult("DELAWARE", 973764, de1bl, de1bb, de1bw, de1tl, de1tb, de1tw, 0.082, 0.217, 0.68)
print("")
calcResult("NORTH DAKOTA", 762062, nd1bl, nd1bb, nd1bw, nd1tl, nd1tb, nd1tw, 0.031, 0.02, 0.94)
print("")
calcResult("SOUTH DAKOTA", 884659, sd1bl, sd1bb, sd1bw, sd1tl, sd1tb, sd1tw, 0.034, 0.017, 0.93)
print("")
calcResult("MONTANA", 1068778, mt1bl, mt1bb, mt1bw, mt1tl, mt1tb, mt1tw, 0.034, 0.004, 0.94)
print("")
calcResult("WYOMING", 578759, wy1bl, wy1bb, wy1bw, wy1tl, wy1tb, wy1tw, 0.096, 0.011, 0.88)
print("")
calcResult("ALASKA", 731545, ak1bl, ak1bb, ak1bw, ak1tl, ak1tb, ak1tw, 0.063, 0.033, 0.90)
print("")
calcResult("VERMONT", 623989, vt1bl, vt1bb, vt1bw, vt1tl, vt1tb, vt1tw, 0.017, 0.012, 0.95)
...
with open("/Volumes/TOSHIBA_BACKUP/usastateswithethnic.txt", 'wb') as f:
